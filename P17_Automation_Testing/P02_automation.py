...
# assert "Hello i am not robot" in output_message.get_attribute('innerHTML')
assert "Hello i am not robot" in output_message.text
# print("Hello i am not robot" in output_message.get_attribute('innerHTML'))
# print("Hello i am not robot" in output_message.text)
