...
# Notice that we are accessing the attributes, and hence we are not using the curly brackets at the end
print(player1.name)
print(player1.age)
...
# Here we are accessing the method, and hence using curly brackets
print(player1.run())
